...
public class OpenSearchConnection {
	...
	public OpenSearchConnection(OpenSearchConnection openSearchConnection) {
		_active = openSearchConnection._active;
		_authenticationEnabled = openSearchConnection._authenticationEnabled;
		_connectionId = openSearchConnection._connectionId;
		_httpSSLEnabled = openSearchConnection._httpSSLEnabled;
		_maxConnections = openSearchConnection._maxConnections;
		_maxConnectionsPerRoute = openSearchConnection._maxConnectionsPerRoute;
		_networkHostAddresses = openSearchConnection._networkHostAddresses;
		_password = openSearchConnection._password;
		_postCloseRunnable = openSearchConnection._postCloseRunnable;
		_preConnectOpenSearchConnectionConsumer =
			openSearchConnection._preConnectOpenSearchConnectionConsumer;
		_proxyConfig = openSearchConnection._proxyConfig;
		_truststorePassword = openSearchConnection._truststorePassword;
		_truststorePath = openSearchConnection._truststorePath;
		_truststoreType = openSearchConnection._truststoreType;
		_userName = openSearchConnection._userName;
	}
