...
public class OpenSearchSearchEngineAdapterSnapshotRequestTest {
	...
	public void setUp() throws Exception {
		...
		_indicesClient = openSearchClient.indices();

		_snapshotClient = openSearchClient.snapshot();
	...
	protected static SearchEngineAdapter createSearchEngineAdapter(
		...
		ReflectionTestUtil.setFieldValue(
			...
			_createSnapshotRequestExecutor(openSearchClientResolver));
	...
	private void _createRepository(String name, String location) {
		...
		builder.putPersistent(FsRepository.LOCATION_SETTING.getKey(), location);
