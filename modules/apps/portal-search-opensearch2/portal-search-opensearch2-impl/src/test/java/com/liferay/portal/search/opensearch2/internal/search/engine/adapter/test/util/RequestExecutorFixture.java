...
import com.liferay.portal.search.opensearch2.internal.search.engine.adapter.index.IndicesOptionsTranslatorImpl;
...
public class RequestExecutorFixture {
	...
	public void setUp() {
		...
		ReflectionTestUtil.setFieldValue(
			_createIndexRequestExecutor, "_openSearchClientResolver",
			_openSearchClientResolver);

		_deleteIndexRequestExecutor = new DeleteIndexRequestExecutorImpl();

		ReflectionTestUtil.setFieldValue(
			_deleteIndexRequestExecutor, "_openSearchClientResolver",
			_openSearchClientResolver);
		ReflectionTestUtil.setFieldValue(
		...
		ReflectionTestUtil.setFieldValue(
			_getDocumentRequestExecutor, "_openSearchClientResolver",
			_openSearchClientResolver);
		ReflectionTestUtil.setFieldValue(
		...
		ReflectionTestUtil.setFieldValue(
			...
			openSearchBulkableDocumentRequestTranslator);
		ReflectionTestUtil.setFieldValue(
			_indexDocumentRequestExecutor, "_openSearchClientResolver",
			_openSearchClientResolver);
		...
		ReflectionTestUtil.setFieldValue(
			...
			openSearchBulkableDocumentRequestTranslator);
		ReflectionTestUtil.setFieldValue(
			_updateDocumentRequestExecutor, "_openSearchClientResolver",
			_openSearchClientResolver);
	}
