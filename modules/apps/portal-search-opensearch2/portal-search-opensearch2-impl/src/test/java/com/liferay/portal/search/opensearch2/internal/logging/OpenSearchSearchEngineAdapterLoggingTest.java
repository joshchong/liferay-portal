...
public class OpenSearchSearchEngineAdapterLoggingTest {
	...
	public static void setUpClass() {
		OpenSearchConnectionFixture openSearchConnectionFixture =
			OpenSearchConnectionFixture.builder(
				...
				OpenSearchSearchEngineAdapterLoggingTest.class.getSimpleName()
			).build();
	...
	public void setUp() {
		_openSearchEngineAdapterFixture = new OpenSearchEngineAdapterFixture() {
			{
				setOpenSearchClientResolver(_openSearchConnectionFixture);
			}
		};

		_openSearchEngineAdapterFixture.setUp();

		_waitForOpenSearchToStart(_openSearchConnectionFixture);
