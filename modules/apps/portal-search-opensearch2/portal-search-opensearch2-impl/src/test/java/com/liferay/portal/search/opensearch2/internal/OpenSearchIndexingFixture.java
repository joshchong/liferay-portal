...
import com.liferay.portal.search.opensearch2.internal.connection.OpenSearchClientResolver;
...
public class OpenSearchIndexingFixture implements IndexingFixture {
	...
	public OpenSearchClientResolver getOpenSearchClientResolver() {
		...
		IndexCreator indexCreator = new IndexCreator() {
			{
				...
				setOpenSearchClientResolver(_openSearchFixture);
			}
		};
